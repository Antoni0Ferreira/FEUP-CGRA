 ...
 * @param top - Texture of the top of the cube
 * @param front - Texture of the front of the cube
 * @param right - Texture of the right of the cube
 * @param back - Texture of the back of the cube
 * @param left - Texture of the left of the cube
 * @param bottom - Texture of the bottom of the cube
 */
