...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/mid.vert", "shaders/mid.frag"),
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/newSepia.frag"),
	...
	display() {
		...
		this.textureWater.bind(1);
		this.textureWater2.bind(2);
