...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.tangramTexture = new CGFtexture(this, 'images/tangram.png');
        ...
        //Initialize scene objects (Unit Cube)
        ...
        this.objects = [this.quad,this.tangram, this.cube];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Quad': 0 , 'Tangram': 1, 'Cube': 2};
        this.textures = [this.texture1, this.texture2, this.texture3, this.tangramTexture];
    ...
    initLights() {
        this.lights[0].setPosition(5, 2, 20, 1);
        this.lights[0].setDiffuse(5.0, 4.0, 4.0, 1.0);
        this.lights[0].setAmbient(10,10,10,10);
    ...
    setDefaultAppearance() {
        ...
        this.setDiffuse(2, 2, 2, 1.0);
        this.setSpecular(4, 4, 4, 1.0);
